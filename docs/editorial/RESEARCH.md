...
_v1.1→v1.2：李洋孢子 #29 撤回事件教訓（讀者抓到「清晨四點多搭捷運」物理矛盾）。§六 新增「紅線擴大：具體場景細節也不能從英文 summary 推導」段落。教訓擴大：不只直接引語要逐字核對，**沒有引號但可被讀者驗證的具體場景細節**（時間/地點/動作/交通/數字）也都要逐字核對。包含真實案例對照表 + 5 條擴大鐵律 + v1.2 擴大自檢問題。對應 EDITORIAL v4.4 紅線擴大。_
