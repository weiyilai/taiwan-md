...
- **Notes**:
  - **範圍純化目標**：1987-2000（解嚴日 → 千禧年）
  - **移除工作**（已被 C 承擔的倒退段）：1983 李昂《殺夫》、1979 蕭颯《我兒漢生》、1982 廖輝英《油麻菜籽》→ 全段刪除
  - **必修事實**：B 既有「廖輝英 1979」需修為 1982（已在 C 修正）
  - **Focus 純度**：政治解禁（白色恐怖文學清算 / 二二八文學復現）/ 女性主義浪潮（朱天心 / 朱天文 / 平路）/ 同志文學（白先勇《孽子》1983 邊界 / 朱天文《荒人手記》1994）/ 原住民文學覺醒（瓦歷斯·諾幹 / 夏曼·藍波安 / 田雅各 1987《最後的獵人》）/ 母語文學復甦（宋澤萊 / 林宗源台語詩）/ 都市後現代（張大春 / 朱天心《古都》1997 邊界）
  - **新加事實**：彭瑞金《台灣新文學運動 40 年》1991 接棒葉石濤、《島嶼邊緣》1991 創刊、報紙副刊文學獎制度成熟（聯合報 / 中時 / 自由 / 林榮三 1989）
  - **核心矛盾候選**：「解嚴給的不是自由，是一套新的限制——市場 vs 政治、本土 vs 國際、純文學 vs 大眾」
  - **敘事結構**：8 個 scene 候選（1987-7-15 戒嚴日 / 朱天心古都 / 田雅各最後的獵人 / 朱天文世紀末華麗 / 平路行道天涯 / 林宗源台語詩 / 報紙文學獎 / 1999 解嚴 12 年文學市場）
- **Reference**: [Issue #635](https://github.com/frank890417/taiwan-md/issues/635) + Phase 1 commit `183f5ef5` 已建立 cross-link 到本文
- **Pre-research**: 部分已在 Phase 1 research report 完成（詳見 reports/research/2026-04/戰後台灣文學.md §0.3 邊界段萃取）；Stage 1 仍需新搜尋 ~15-20 次
...
- **Notes**:
  - **範圍純化目標**：21 世紀至今（2000-）
  - **吸納工作**（從 C 移過來的）：施叔青台灣三部曲《行過洛津》（2003）、《風前塵埃》（2008）、《三世人》（2010）、蘇偉貞《沉默之島》（1994）等
  - **既有強項保留**：吳明益《單車失竊記》2018 國際布克獎、林奕含《房思琪的初戀樂園》2017、甘耀明、童偉格、連明偉、黃崇凱、PTT 與部落格文學、文學獎制度、類型文學興起、數位時代新文學形式
  - **新加事實**：李奕樵 / 黃麗群 / 賀景濱 / 黃崇凱《文藝春秋》2017
  - **核心矛盾候選**：「當代台灣文學第一次有了國際能見度，但內部閱讀人口卻在崩塌」（D 既有 hint 已點到）
  - **架構建議**：保留 D 既有 8 個小節，但範圍純化（吳明益國際化、林奕含、施叔青三部曲、數位浪潮、中生代多元、文學獎、閱讀人口危機、國際視野、類型文學、數位新形式）
- **Reference**: [Issue #635](https://github.com/frank890417/taiwan-md/issues/635)
- **Pre-research**: D 既有素材豐富，主要是吸納 C 的 1990s+ 段 + 補新作家

### 台灣當代文學發展 dropped 處理（Issue #635 Phase 4/4）

- **Type**: `EVOLVE`（其實是 `archive` 但 INBOX 沒這個 type，借 EVOLVE 標識）
- **Category**: Art
...
- **Requested**: 2026-04-26 by Issue #635 idlccp1984 (γ session)
- **Notes**:
  - **處理方式**：A 文 1945-2018 全景內容已被 B+C+D 三段完整覆蓋
  - **dropped 選項**：
    - A) 整檔 archive 到 `knowledge/.archive/2026-04-26-台灣當代文學發展.md`，留紀錄
    - B) 改寫為極短「全景索引」hub 頁面，把 1945-1987 / 1987-2000 / 2000-now 三段內容指向 C/B/D 三篇
    - C) 內容合併到 [台灣文學史](/art/台灣文學史) 作為現代段落補強，A 路徑 redirect
  - **建議**：B 方案（極短 hub）最尊重 A 既有 featured + lastHumanReview: true 狀態，並提供讀者一個導覽入口
  - **必處理**：全站 grep `台灣當代文學發展` 內部 link，全部改指向 B/C/D 對應段
  - **slug 不可中斷**：保留 `/art/台灣當代文學發展/` URL 不死（避免 SEO 404）
- **Reference**: [Issue #635](https://github.com/frank890417/taiwan-md/issues/635)
- **Pre-research**: 不需新研究，純結構性決定 + 全站 cross-link audit
