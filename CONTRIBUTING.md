...
> 📋 **完整翻譯任務看板**：[TRANSLATION-BOARD.md](TRANSLATION-BOARD.md)
> 🤖 **AI 翻譯 Prompt**：[TRANSLATE_PROMPT.md](TRANSLATE_PROMPT.md)

#### 最簡單的翻譯流程

1. 看 [TRANSLATION-BOARD.md](TRANSLATION-BOARD.md) 挑一篇你有興趣的文章
2. 把 [TRANSLATE_PROMPT.md](TRANSLATE_PROMPT.md) 貼給你的 AI（Claude/ChatGPT/Gemini）
