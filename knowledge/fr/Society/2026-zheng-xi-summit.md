...
Dans l'entretien, Cheng Li-wên a formulé cinq propositions — pour « promouvoir la paix par les échanges et le développement par la coopération », selon ses propres mots[^10] :
...
D'après le texte intégral de l'allocution rendu public après la rencontre[^12], le discours de Xi Jinping peut se résumer en quelques phrases :
