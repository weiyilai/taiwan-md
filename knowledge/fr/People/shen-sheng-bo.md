...
Cette trajectoire explique en quoi ses œuvres se distinguent de beaucoup d'autres pratiques des nouveaux médias qui utilisent la technologie comme simple matériau. Pour Shen, le code n'est pas un outil d'effets visuels — c'est une façon de penser le monde. Ce qui l'intéresse, ce n'est pas l'esbroufe technique, mais cette question fondamentale : **comment les règles du monde numérique révèlent-elles en retour notre façon d'appréhender le réel ?**

## De l'informatique à l'art technologique

Sur le plan biographique, Shen Sheng-Bo semble avoir progressivement migré de l'ingénierie vers l'art. Après sa licence et son master en informatique à l'Université Chiao Tung, il part étudier le Creative Technology à l'Université de Salford au Royaume-Uni, avant de travailler à son retour au sein de structures liées à l'art technologique — notamment Microplayground et dimension+ — et de rejoindre OpenLab.Taipei.

Cette période est décisive : elle correspond au moment où l'art numérique taïwanais commence à dépasser la simple dimension spectaculaire des installations interactives pour construire une communauté créative plus mature. C'était une époque où de nombreuses personnes savaient programmer sans savoir comment en faire de l'art, et où d'autres voulaient faire de l'art sans avoir accès à des références locales en matière de création par le code. Shen Sheng-Bo se tenait précisément à la jonction de ces deux univers.

> 📝 **Note de curateur**
> Parmi les figures importantes de l'art numérique à Taïwan, nombreuses sont celles dont la trajectoire paraît improbable : elles ne viennent pas d'une formation en histoire de l'art pour ensuite saisir la technologie comme outil, mais ont d'abord vécu dans le monde technique avant de développer progressivement leur propre langage artistique. Shen Sheng-Bo est l'une des figures emblématiques de cette voie.

## « Le code comme mode de vie » : l'héritage conceptuel

Si l'on devait résumer le cœur de la démarche de Shen Sheng-Bo en une formule, ce serait celle que reprennent aussi bien Wikipédia que la base de données de l'art contemporain taïwanais : **il interroge les propriétés réglementaires du domaine numérique et croit que le code est un mode de vie.**

Cette affirmation, qui peut sembler abstraite, est en réalité très forte. Elle ne dit pas « la programmation c'est amusant » ni « la technologie rend l'art plus cool », mais fait de l'algorithmique, du hasard, des règles systémiques et des structures de données une composante à part entière de l'expérience quotidienne. Alors que la vie humaine est de plus en plus enveloppée par des systèmes numériques, l'art qui veut comprendre cette époque ne peut se contenter de produire de belles interactions ; il doit remonter aux fondements : comment les règles sont-elles écrites ? Qui décide de la logique de l'interaction ? Comment les systèmes façonnent-ils nos perceptions ?

C'est ce qui rend les œuvres de Shen Sheng-Bo toujours aussi pertinentes, plus de dix ans après leur création : elles ne traitent pas des tendances de l'installation, mais de la structure profonde de la vie numérique.
...
Son influence dépasse donc le cadre des expositions : elle s'exerce dans la transmission du savoir. Il a aidé toute une génération à croire que **programmer n'est pas l'apanage des ingénieurs — c'est aussi le langage des artistes.**

Cela transparaît également dans les traces qu'il a laissées sur GitHub. Le compte `shengpo` contient non seulement le code source de ses œuvres, mais aussi des dépôts à vocation clairement pédagogique ou de partage d'outils : `processing_snips`, `processing_quiz`, `ProjectionMapping_exercises`, `cascadePlayer`, `helloFace`. Ces projets ressemblent à des carnets de notes ouverts : il ne gardait pas ses méthodes pour lui, mais les décomposait pour que d'autres puissent apprendre, modifier, poursuivre.

En d'autres termes, ce qu'il a laissé n'est pas un portfolio fermé sur lui-même, mais un espace de création ouvert que ses successeurs pouvaient prendre en main. C'est pourquoi ceux qui évoquent Shen Sheng-Bo ne retiennent pas seulement une œuvre, mais la façon dont il a rendu évident le lien entre Processing, open source et art numérique.

## L'espace Youwei : donner un lieu à l'expérimentation

En 2011, Shen Sheng-Bo fonde l'espace Youwei à Taichung. C'est un geste fondamental.

Un artiste qui ne laisse que des œuvres exerce une influence ponctuelle. Mais quand il crée un espace où d'autres artistes peuvent aussi exposer, tester et se confronter, l'influence se transforme en champ de force. D'après les données publiques, l'espace Youwei était non seulement un lieu d'exposition, mais une base pour les artistes souhaitant expérimenter et se produire.

À Taïwan, le centre et le sud du pays souffrent depuis longtemps d'une concentration des ressources culturelles à Taipei. Un espace comme Youwei représente une pratique culturelle locale fondamentale : ne pas attendre que les grandes institutions redistribuent les ressources, mais construire soi-même, sur place, un environnement expérimental capable de respirer.

Si OpenLab.Taipei représente la communauté et le réseau, l'espace Youwei représente l'ancrage et la durée. Ces deux dimensions réunies font que l'influence de Shen Sheng-Bo dépasse le cadre de l'artiste individuel pour devenir une infrastructure communautaire.

## Après la maladie : des œuvres qui vont plus loin vers l'intérieur
...
Concrètement, il a incarné une figure de créateur alors rare à Taïwan, mais de plus en plus centrale :

- Capable d'écrire du code et de faire de l'art
- Capable de penser les systèmes et de traiter les perceptions
- Capable de créer des œuvres et d'accompagner d'autres personnes dans la pratique
- Ne faisant pas du logiciel libre un slogan, mais le traduisant en enseignement, communauté et espace

Ces conditions réunies font de lui quelqu'un qui « n'a pas eu le temps de se déployer pleinement, mais a clairement indiqué une direction ».

## Ce qu'il a vraiment transmis aux générations suivantes
...
Cet esprit n'a pas vieilli.

## Références

- [Shen Sheng-Bo (Wikipédia)](https://zh.wikipedia.org/zh-tw/%E6%B2%88%E8%81%96%E5%8D%9A)
- [Shen Sheng-Bo — Taiwan Contemporary Art Archive (TCAA)](https://tcaaarchive.org/Artist/Detail/1334)
- [Shen Sheng-Bo — ArTemperor](https://artemperor.tw/knowledge/2372)
- [OpenLab.Taipei](https://openlabtaipei.org/)
- [Cours avancé Processing (blog Insomnia608)](https://insomnia608.pixnet.net/blog/posts/7096944218)
...
- [shengpo sur GitHub](https://github.com/shengpo)
- [Exposition commémorative Shen Sheng-Bo : donner une nouvelle vie par le code (ArTemperor)](https://artemperor.tw/focus/1221)
- [Le troisième round — Exposition commémorative Shen Sheng-Bo (Archives du Conseil national des arts)](https://archive.ncafroc.org.tw/result?id=b9c7810cda4f41b9994aa2d81925be02)
- [Noblesse et pureté dans la chaleur technologique : pin shadow et texture de Shen Sheng-Bo](https://atatw.org/hta-archive/%E7%A7%91%E6%8A%80%E6%BA%AB%E5%BA%A6%E4%B8%AD%E7%9A%84%E9%AB%98%E5%B0%9A%E7%B4%94%E6%BD%94%EF%BC%9A%E6%B2%88%E8%81%96%E5%8D%9A%E7%9A%84%E3%80%8Apin-shadow%E3%80%8B%E8%88%87%E3%80%8Atexture%E3%80%8B/)

## Sujets connexes

- Wu Che-Yu : une autre trajectoire taïwanaise de la programmation vers l'art
- Audrey Tang : comment la pensée technologique s'inscrit dans le domaine public
